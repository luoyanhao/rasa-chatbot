...
class LSTMNER:
    def __init__(self):
        ...
        self.vocab_path = os.path.join(cur, 'DBService/vocab.txt')
        self.embedding_file = os.path.join(cur, 'DBService/token_vec_300.bin')
        self.model_path = os.path.join(cur, 'DBService/tokenvec_bilstm2_crf_model_20.h5')
